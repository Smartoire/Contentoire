...
export class NewsSourceTemplate implements INewsSource {
  ...
  id = NewsSourceTemplate.id;
  provider = NewsSourceTemplate.provider;
  description = NewsSourceTemplate.description;
  logo = NewsSourceTemplate.logo; // <-- Instance property
...
export interface IAuthProvider {
  ...
  getSettings(): Promise<any>;
  saveSettings(settings: any): Promise<void>;
  // Optionally, you can add methods like authenticate, etc.
}
...
export class AuthProviderTemplate implements IAuthProvider {
  ...
  static description = 'A template for implementing an auth provider.';
...
export default NewsSourceTemplate;
